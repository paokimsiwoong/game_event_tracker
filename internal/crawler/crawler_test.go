    ...
    <div class="notice">
      ...
      <div class="content-box">
        <div class="content-preview">
          ...
          <div class="date-text" data-date="1752796800"></div>
          <div class="image-wrapper">
            <img src="banner/8_1746175810_41721747199779.jpg">
          </div>
          <div class="text-wrapper">
            <div class="main-text">
              <b>최강의 짜랑고우거가 출현 중!</b><br />7월 21일(월) 8:59까지, ★7의 검은 결정 테라 레이드배틀에 <b>짜랑고우거</b>가 출현 중!<br />이번에 출현하는 짜랑고우거는 격투 테라스탈타입의 매우 강력한 포켓몬!<br />본 이벤트에 출현하는 최강의 짜랑고우거는 <b>「최강의증표」</b>를 가지고 있습니다.<br />또한, ★5의 테라 레이드배틀 결정에서 해피너스를 만나기 쉬워진다고 합니다!<br />출현하는 해피너스는 다양한 테라스탈타입을 가지고 있습니다.<br />승리하면 <b>다양한 타입의 테라피스</b>와 <b>경험사탕</b>을 평소보다 <b>많이 획득할 수 있습니다!</b><br />트레이너들과 힘을 합쳐서 승리해 보시기 바랍니다!<br /><h4>※본 이벤트에서 출현하는 최강의 짜랑고우거는 하나의 저장 데이터에서 1마리만 잡을 수 있습니다. 잡은 뒤에도 기간 안에 검은 결정 테라 레이드배틀에 참가하면, 보상을 받을 수 있습니다.<br />※본 이벤트에서 출현하는 짜랑고우거는 경우에 따라, 추후 이벤트에서 다시 출현하거나 다른 방식으로 만날 수 있습니다.</h4><br /><h1>기간</h1>2025년 7월 18일(금) 9:00~7월 21일(월) 8:59<br />(종료)2025년 7월 11일(금) 9:00~7월 14일(월) 8:59<br /><h4>두 개최 기간에 출현하는 「최강의 짜랑고우거」는 능력과 배운 기술이 같습니다. 앞선 기간에서 「최강의 짜랑고우거」를 잡은 경우, 「최강의 짜랑고우거」를 추가로 잡을 수 없습니다.</h4><br /><h1>출현 포켓몬</h1>★7: 최강의 짜랑고우거<br />★5: 해피너스<br /><br /><h1>이벤트 테라 레이드배틀이란?</h1>이벤트 테라 레이드배틀은 시기별로 출현하는 포켓몬이 바뀝니다.<br />좀처럼 보기 어려운 테라스탈타입의 포켓몬을 만날 수도 있다고 합니다.<br />포켓포털 등의 정보를 확인해서 원하는 포켓몬을 찾았다면 도전해 보시기 바랍니다.<br /> <br /><h1>이벤트 테라 레이드배틀에 도전 시 주의사항</h1>・이벤트 테라 레이드배틀을 플레이하려면 아래 방법으로 최신 정보를 받아야 합니다.<br /><h3><b>「포켓포털」→「이상한 소포」→「포켓포털 뉴스를 받는다」</b><br />※Nintendo Switch Online(유료) 가입은 필요하지 않습니다.</h3>・검은 결정 테라 레이드배틀에 도전하려면 엔딩 후에 진행할 수 있는 이벤트를 클리어해야 합니다. 단, 멀티 플레이 중인 트레이너의 테라 레이드배틀에 참가하거나, 암호를 통해 지인의 테라 레이드배틀에 참가하는 경우, 이벤트를 클리어하지 않은 트레이너도 검은 결정 테라 레이드배틀에 참가할 수 있습니다.<br />・★5 테라 레이드배틀에 도전하려면 엔딩까지 진행해야 합니다. 단, 멀티 플레이 중인 트레이너의 테라 레이드배틀에 참가하거나, 암호를 통해 지인의 테라 레이드배틀에 참가하는 경우, 엔딩까지 진행하지 않은 트레이너도 ★5 테라 레이드배틀에 참가할 수 있습니다.<br />・인터넷 통신을 이용해 다른 트레이너와 테라 레이드배틀을 플레이하려면 Nintendo Switch Online(유료)에 가입해야 합니다.<br />・이벤트 테라 레이드배틀은 팔데아지방에서만 발생합니다.
            </div>
          </div>
        </div>
      </div>
